...
# assessment data 
assessment_raw <- read.csv("02_data_source_files/ies_dataset_2021_0527.csv")
# master file (roster)
...
### Removing the original ID 

ies_aggregation <- ies_aggregation %>% select(-student_id)



### Filtering out the problem-level data 

ies_aggregation_student <- ies_aggregation[ ,grepl("StuID|condition_assignment|pre.|mid.|post.|delayed.", 
...
# 
# write.csv(x = ies_aggregation_student, 
#            path = "ies_assessment_aggregation_student_20220629.xlsx", col_names = TRUE)
