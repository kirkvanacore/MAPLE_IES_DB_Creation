...
# Problem list 
db_problem_list <- read_excel("db_problem_list_updated.xlsx")
...
```{r}
db_problem_level <- db_problem_level %>% select(-'student_id', -'s2_name',-'s2_tablet_id',-'s3_name',-'s3_tablet_id',-'s4_name', -'s4_tablet_id', -'s5_name', -'s5_tablet_id', -'s7_name', -'s7_tablet_id',
-'s8_name', -'s8_tablet_id', -'s9_name', -'s9_tablet_id', -'s10_name', -'s10_tablet_id',
-'s11_name', -'s11_tablet_id', -'Device Number', -'Notes')
```


# Export data files 
```{r}
write_xlsx(x = db_problem_level, path = "DB_aggregation_merge_2022_0913.xlsx", col_names = TRUE)
```
