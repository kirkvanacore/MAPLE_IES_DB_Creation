...
```{r}
# reordering
df <- df %>% relocate(student_number, student_id, StuID, initial_school_id,                                  
                      initial_SchID, final_school_id, final_SchID, initial_teacher_id,
                      initial_TeaID,                         
                      initial_TeaID_within_school, final_teacher_id, final_TeaID, 
                      final_TeaID_within_school, initial_teacher_class, initial_ClaID,                        
                      final_teacher_class, final_ClaID, initial_section_number, 
                      initial_SecID, final_section_number, final_SecID)
...
df <- df %>% relocate(c(G5SCHOOL, G5SchID, G5SCHOOL2, G5SchID2, G5SCHOOL3, G6SCHOOL, G6SchID, G6SCHOOL2, G6SchID2, G6SCHOOL3), .after = SST)
```
...
```{r}
write_xlsx(x = df, 
           path = "roster_demographic_2022_06_16_N=4,343.xlsx", col_names = TRUE)
```
